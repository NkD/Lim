...
public class ConeLight extends PositionalLight {
     ...
     * @param coneDegree
     */
    public ConeLight(RayHandler rayHandler, int rays, Color color, float distance, float x, float y, float directionDegree, float coneDegree, float body2WorldScale) {

        super(rayHandler, rays, color, distance, x, y, directionDegree, body2WorldScale);
