...
public abstract class Light {
    ...
    protected final float body2WorldScale;
    ...
    Light(RayHandler rayHandler, int rays, Color color, float directionDegree, float distance, float body2WorldScale) {
        ...
        setColor(color);
        this.body2WorldScale = body2WorldScale;
    }
