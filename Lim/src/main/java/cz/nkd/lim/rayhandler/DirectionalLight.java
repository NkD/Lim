...
public class DirectionalLight extends Light {
     ...
     */
    public DirectionalLight(RayHandler rayHandler, int rays, Color color, float directionDegree, float body2WorldScale) {

        super(rayHandler, rays, color, directionDegree, Float.POSITIVE_INFINITY, body2WorldScale);
        ...
        softShadowMesh = new Mesh(staticLight, vertexNum, 0, new VertexAttribute(Usage.Position, 2, "vertex_positions"), new VertexAttribute(Usage.ColorPacked, 4, "quad_colors"), new VertexAttribute(Usage.Generic, 1, "s"));
        update();
    }
